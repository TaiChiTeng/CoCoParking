 ...
 declare namespace wx {
     ...
     */
     ...
     interface InterstitialAd {
         ...
         onClose(callback: (res) => void): void;
     }
     ...
     /** 隐藏 loading 提示框*/
     function hideLoading(success?: (res?: any) => void, fail?: (res?: any) => void, complete?: (res?: any) => void ): void;
     ...
     */
      ...
      * 显示当前页面的转发按钮
      */
     function showShareMenu(object: { withShareTicket?: boolean, menus?: Array<any>, success?: (res?: any) => void, fail?: (res?: any) => void, complete?: (res?: any) => void }): void;
     ...
     */
     ...
     interface Video {
          ...
          * 监听视频播放到末尾事件
          */
         onEnded(callback: (res) => void): void;
         /**
          * 取消监听视频播放到末尾事件
          */
         offEnded(callback: () => void): void;
     ...
     function createVideo(object: {
         ...
         controls?: boolean, autoplay?: boolean,
