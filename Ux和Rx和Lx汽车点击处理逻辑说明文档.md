...
Ux汽车是指从停车场下方向上进入的汽车，可以向上或向下移动。Ux的车尾总是=车头+长度-1。
Rx汽车是指从停车场左方向右进入的汽车，可以向右或向左移动。Rx的车尾总是=车头-长度+1。
Lx汽车是指从停车场右方向左进入的汽车，可以向左或向右移动。Lx的车尾总是=车头+长度-1。

特别的，如果汽车都在停车场外（inPark=0）：
Ux，Lx汽车，sort+1的车，车头位置=sort的车的车尾+1。
Rx汽车，sort+1的车，车头位置=sort的车的车尾-1。
